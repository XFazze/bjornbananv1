...
# Enable/disable command
    ...
    async def category(self, ctx, category: discord.CategoryChannel = None, command: str = None):
        print("disabling category ", category, command)

    @disable.command(pass_context=True)
    async def channel(self, ctx, channel: discord.TextChannel = None, command: str = None):
        print("disabling channel ", channel, command)
